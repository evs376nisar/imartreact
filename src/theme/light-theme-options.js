...
const primary = {
  main: "#5e9918",   // ← updated to your color
  deep: "#5e9918",
  light: "#EBFDF2",
  dark: "#5e9918",   // ← adjusted darker version for hover
  semiLight: "#E4FFF3",
  contrastText: "#FFFFFF",
  customType1: "#0DCB72",
  customType2: "#3BB77E",
  customType3: "#29CE00",
  overLay: "#000000",
  lite: "rgba(94, 153, 24, 0.1)", // matched to new main
  icon: "#5e9918",
};
...
const text = {
	...
	custom: "#3F3F3F",
	customText1: "#4B5563",
	contrast: "#FFFFFF", // added white text option
};
...
export const lightThemeOptions = {
	components: {
		...
		// ← Updated: Make button text white including disabled
	MuiButton: {
  styleOverrides: {
    root: {
      color: "#FFFFFF",
